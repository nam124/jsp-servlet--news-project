package com.nam317.controller.admin.api;
...
import com.nam317.Utils.HttpUtil;
...
public class NewAPI extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) //thêm dùng do dopost
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) // cập nhật dùng doput
			throws ServletException, IOException {
		ObjectMapper mapper = new ObjectMapper();
		request.setCharacterEncoding("UTF-8");
		response.setContentType("application/json");
